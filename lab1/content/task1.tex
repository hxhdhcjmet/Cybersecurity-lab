...
根据实际的Ping结果应当指出，“掩码错”对应两个阶段：初始阶段Client向网关192.168.3.1发出ARP请求，ARP响应来自OpenWRT；收到ICMP Redirect后，Client再次发出ARP请求，ARP响应来自Victim。两个阶段的ICMP源、目的IP仍然是192.168.3.10和192.168.3.200，变化的是以太网帧的下一跳MAC地址。
